#/bin/sh
OPTIONS="--server=https://192.168.64.2:8443 --username minikube --password '' --certificate-authority=/minikube/ca.crt --client-certificate=/minikube/client.crt --client-key=/minikube/client.key"
